...
const moodOptions: Array<{
  ...
  { value: "muito_bem", label: "Muito bem", description: "Dia leve e energizante", icon: Sparkles },
  { value: "bem", label: "Bem", description: "Ritmo equilibrado e estável", icon: Heart },
  { value: "neutro", label: "Neutro", description: "Sentimentos mistos ou sem grandes oscilações", icon: Meh },
  { value: "desafiador", label: "Desafiador", description: "Alguns pontos de atenção ao longo do dia", icon: Frown },
  { value: "dificil", label: "Difícil", description: "Momento mais pesado ou cansativo", icon: CloudRain },
];
